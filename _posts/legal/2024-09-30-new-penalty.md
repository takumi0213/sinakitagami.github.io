...
なお、**グローバルチャットでの違反行為については、自動モデレーション機能により、  
警告を経ずに恒久的な利用停止処理が即時実行される場合**があります。
...
返信された内容は運営側では確認できないため、**必ず上記のフォームをご利用ください。**
...
- **なぜ不当であると考えるのか**を、できる限り具体的に記載してください  
